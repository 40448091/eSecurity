...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void ExportKeyPair()
        {
            ...
            if(p.IsInitialized())
            {
                p.ExportKeyPair("C:\\temp\\keyPair.ecc");
            }
        }
        ...
        public void ImportKeyPair()
        {
            ...
            if (!p.IsInitialized())
            {
                p.ImportKeyPair("C:\\temp\\keyPair.ecc");
                Assert.IsTrue(p.IsInitialized());
            }
        }
        ...
        public void ExportPublicKey()
        {
            ...
            if (p.IsInitialized())
            {
                p.ExportPublicKey("C:\\temp\\pubKey.ecc");
            }
        }
        ...
        public void LoadPublicKey()
        {
            ...
            if (p.IsInitialized())
            {
                IPublicKey pubKey =  p.LoadPublicKey("C:\\temp\\pubKey.ecc");
